<div class="row">
	...
	<div id="messegeResult_err">
		...
		<div class="col-sm-12">
			<p id="slogan">Вы найдете, что ищете.</p>
			<p id="text_desc">Химические реагенты для нефтегазодобывающих предприятий.</p>
		</div>
	</div>	
	<div class="row">
		<div class="col-sm-3">
			<p id="excist_head">Всегда в наличии</p>
			<p id="excist">Вы всегда сможете найти в наличии на нашем складе в г. Пыть-Ях следующую продукцию:</p>
			<ul id="excist_li">
				<li class="excist_item" id="izvest_m_li">Известь гидратная</li>
				<li class="excist_item" id="natr_edk_m_li">Натрий едкий гранулированный</li>
				<li class="excist_item" id="grafit_m_li">Графит</li>
				<li class="excist_item" id="microcalcit_m_li">Микрокальцит</li>
				<li class="excist_item" id="barit_m_li">Барит</li>
				<li class="excist_item" id="asphalt_m_li">Сульфированный асфальт</li>
			</ul>
		</div>
		<div class="col-sm-3" style="margin-top:8%; padding-left:9%; padding-right:0%; margin-right:0%">
			<div id="hexagon">
			</div>
			<div id="hexagon_ins">
				<p class="text_blocks">Утяжелители для бурения и глушения скважин</p>
				<div id="positions_main">
		...
		<div class="col-sm-3" style="margin-top:10%; margin-bottom:33%">
			<div id="hexagon_3">
			</div>
			<div id="hexagon_ins_3">
				<p class="text_blocks" style="padding-top:12%">Химические реагенты для водных растворов</p>
				<div id="positions_3_main">
					<ul class="list_products">
						...
						<li class="item" id="asphalt_li">Сульфированный асфальт</li>
						<li class="item" id="poliakrilat_li">Полиакрилат натрия</li>
						<li class="item" id="poliakrilamid_li">Полиакриламид</li>
						<li class="item" id="kaliy_li">Калий хлористый</li>
						<li class="item" id="izvest_li">Известь гидратная</li>
						<li class="item" id="grafit_li">Графит</li>
